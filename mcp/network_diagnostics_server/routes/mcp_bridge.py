...
from qwen_agent.tools.base import register_tool, is_tool_schema
from .mcp import mcp
...
If there is any missing information, please ask the user for more information.
            ...
            try:
                ...
                while not finished:
                    ...
                    if last_response.get('function_call', None):
                        ...
                        # If no functions are being called, we assume that the assistant is either done or is waiting ofr user input.
                        finished = True
