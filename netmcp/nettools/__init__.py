...
This package contains the network diagnostic tool implementations for NetAssist.
"""
...
from .networkd import get_network_status_impl, \
    get_network_config_file_impl, \
    set_network_static_impl, \
    reload_network_impl
